...
//url de storage
const URL3 ="/storage/files/buckets/public/avatars"
export const URL ="https://wvtbqhwauoysaisqwizo.supabase.co/storage/v1/object/public/avatars/"
const URL2= "/storage/v1/object/sign/avatars/1774996038868.jpeg"
...
const UserProfile: React.FC<UserProfileProps> = ({
    ...
    const [profile, setProfile] = useState<UserProfileData | null>(user as unknown as UserProfileData);
    ...
    useEffect(()=>{
        if(user){
            setProfile(user as unknown as UserProfileData)
